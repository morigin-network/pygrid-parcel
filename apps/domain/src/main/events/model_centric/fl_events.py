...
def report(message: dict, socket=None) -> dict:
    ...
    try:
        ...
        diff_docid = data.get(CYCLE.DIFF,None) #base64.b64decode(data.get(CYCLE.DIFF, None).encode()) #)
        # print(model_manager.unserialize_model_params(diff_docid))
        # print("Success")
        ...
        processes.submit_diff(worker_id, request_key, diff_docid)
